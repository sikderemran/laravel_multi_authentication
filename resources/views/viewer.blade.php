			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href=" {{route('viewer.dashboard')}} "><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>	
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Details</span>
							<ul>
								<li><a class="submenu" href="{{route('employeeDetails')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">My Details</span></a></li>
							</ul>	
						</li>
					</ul>
				</div>
