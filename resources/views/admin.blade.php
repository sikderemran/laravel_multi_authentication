	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>Multiple Category User Registration and Data Store System</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Details</span>
							<ul>
								<li><a class="submenu" href="{{route('allUser')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All User</span></a></li>
								<li><a class="submenu" href="{{route('allEmployee')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Employee</span></a></li>
							</ul>	
						</li>
					</ul>
				</div>
